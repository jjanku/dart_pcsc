...
class PcscLib {
  ...
  ffi.Pointer<pkg_ffi.Char> pcsc_stringify_error(
    int arg0,
  ) {
  ...
  late final _pcsc_stringify_errorPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<pkg_ffi.Char> Function(LONG)>>(
...
class SCARD_READERSTATE extends ffi.Struct {
  external ffi.Pointer<pkg_ffi.Char> szReader;
  ...
  @ffi.Array.multi([33])
  external ffi.Array<pkg_ffi.UnsignedChar> rgbAtr;
}
...
// especially check the size of SCARDCONTEXT and SCARDHANDLE
typedef LONG = pkg_ffi.Long;
typedef LPCVOID = ffi.Pointer<ffi.Void>;
typedef LPSCARDCONTEXT = ffi.Pointer<SCARDCONTEXT>;
typedef SCARDCONTEXT = pkg_ffi.IntPtr;
typedef LPCSTR = ffi.Pointer<pkg_ffi.Char>;
typedef LPSCARDHANDLE = ffi.Pointer<SCARDHANDLE>;
typedef SCARDHANDLE = pkg_ffi.IntPtr;
typedef LPDWORD = ffi.Pointer<DWORD>;
typedef LPSTR = ffi.Pointer<pkg_ffi.Char>;
typedef LPBYTE = ffi.Pointer<BYTE>;
typedef BYTE = pkg_ffi.UnsignedChar;
